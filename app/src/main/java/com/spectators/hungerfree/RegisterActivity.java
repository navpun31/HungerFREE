                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            database.child(id).setValue(profile);
...
//                            updateUI(null);
    ...
    private void postDataToSQLite() {
        ...
        if (!databaseHelper.checkUser(textInputEditTextEmail.getText().toString().trim())) {
            ...
            profile.setName(textInputEditTextName.getText().toString().trim());
            profile.setEmail(textInputEditTextEmail.getText().toString().trim());
            profile.setMobile(textInputEditTextMobile.getText().toString().trim());
